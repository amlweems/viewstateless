...
namespace ViewStateless {
    ...
    public sealed class Purpose {
        ...
        public CryptographicKey DerivedEncryptionKey { get; private set; }
        public CryptographicKey DerivedValidationKey { get; private set; }
        ...
        public bool SaveDerivedKeys { get; set; }
        ...
        public Purpose AppendSpecificPurpose(string specificPurpose) {
        ...
        // Leaves the original Purpose unmodified.
        public Purpose AppendSpecificPurposes(IList<string> specificPurposes) {
        ...
        public void GetKeyDerivationParameters(out byte[] label, out byte[] context) {
